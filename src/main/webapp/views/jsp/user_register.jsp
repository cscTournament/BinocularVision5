        ...
        <div class="col-md-6 col-md-offset-3">
            <form action="addUser"  method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="first_nameForm" name="first_name" path="first_name" class="form-control" placeholder="<fmt:message key="register.form.first.name.placeholder"/>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="last_nameForm" name="last_name" path="last_name" class="form-control" placeholder="<fmt:message key="register.form.last.name.placeholder"/>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="loginForm" name="login" path="login" class="form-control" placeholder="<fmt:message key="register.form.login.placeholder"/>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="password" id="passwordForm" type="password" path="password" class="form-control" placeholder="<fmt:message key="register.form.password.placeholder"/>"
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" step="0.01" id="balanceForm" name="balance"  path="balance" class="form-control" placeholder="<fmt:message key="register.form.balance.placeholder"/>"
